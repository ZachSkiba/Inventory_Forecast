...
Basic EDA: spending distribution, category breakdown, monthly trends
...
This is what gets you the Tier 1 interview.
...
Walk-forward cross-validation — proper time series evaluation, not just train/test split
...
Feature engineering — lag features (1, 2, 3 months), rolling averages (3-month, 6-month), month-of-year, spending ratios
...
Resume bullet finalized (see below)


Full Project Timeline
PhaseTimelineDeliverableClass baselineWeek 1Notebook: SARIMA + Prophet + decompositionCategory forecasting + CVSummer Week 1–3Expanded notebookXGBoost ML layerSummer Week 4–6Full forecasting pipelineAnomaly detectionSummer Week 7Anomaly moduleDashboardSummer Week 8–9Streamlit appPortfolio polishSummer Week 10GitHub + write-up
